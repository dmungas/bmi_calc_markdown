...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 90 }, { marker: 'pandoc', elapsed: 64 }, { marker: 'post-processor', elapsed: 69 }, { marker: 'pre-processor', elapsed: 150 }, { marker: 'render', elapsed: 291 } ];
